...
(function() {
  ...
  MULTIMIX._get_seed = function(L, S, seed, do_copy) {
  ...
  MULTIMIX.mix = function(L, mixins, reducers, root, selector) {
    var S, field_key, field_value, fields, hook, i, j, len, len1, mixin, mixin_seed, mixin_tail, mx_key, mx_value, partial_mixin, partial_mixins, reducer, reducers_seed, ref, ref1, ref2, seed, type;
    if (root == null) {
      root = null;
    }
    if (selector == null) {
    ...
    if (reducers_seed != null) {
      seed = MULTIMIX._get_seed(L, S, reducers_seed, false);
    } else {
      seed = MULTIMIX._get_seed(L, S, mixin_seed, true);
    }
    S.seed = seed;
    if (root == null) {
      root = seed;
