(function() {
  'use strict';
  var GUY, H, alert, debug, echo, get_types, help, info, inspect, iterator_symbol, log, multimix_symbol, nameit, node_inspect, plain, praise, rpr, rvr, stringtag_symbol, truth, urge, warn, whisper;
