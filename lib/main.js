...
(function() {
  ...
  MULTIMIX.mix = function(L, mixins, reducers, root, selector) {
    var R, S, copy, description, field_key, field_value, fields, has_fields, hook, i, j, len, len1, mixin, mixin_seed, mixin_tail, mx_key, mx_value, partial_mixin, partial_mixins, reducer, reducers_seed, ref, ref1, ref2, ref3, seed, seen, type;
    if (root == null) {
      root = null;
    }
    if (selector == null) {
    ...
    if ((hook = (ref3 = S.reducers) != null ? ref3['after'] : void 0) != null) {
