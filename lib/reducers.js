...
(function() {
  ...
  this[σ_new_state] = function(reducers, seen) {
    var S, fields, key, reducer, ref, value;
    if (seen == null) {
      seen = null;
    }
    S = {};
  ...
  this[σ_finalize] = function(S) {
    ...
    /* tags */
    var count, key, method, ref, ref1, ref2, ref3, sum, value, values;
    ref = S.current;
    for (key in ref) {
      value = ref[key];
  ...
  this[σ_reject] = function(S, key, value) {
    return value === void 0 && S.reducer_name !== 'assign';
  };
