...
(function() {
  var CND, a, alert, badge, d, debug, echo, help, include, info, log, mix, rpr, s, t, test, unicopy, urge, warn, whisper,
  ...
  this["`mix.copy` gives shallow copy of an object"] = function(T) {
    var options_copy, options_original;
    options_original = {
      paths: {
        app: '~/sample',
        fonts: '~/.fonts'
  ...
  if (module.parent == null) {
    include = ["demo (1)", "options example (1)", "options example (2)", "options example (3)", "options example with nested reducers", "unused reducers must not cause entry", "`mix.copy` gives shallow copy of an object"];
