...
(function() {
  ...
  if (module.parent == null) {
    include = ["demo (1)", "options example (1)", "options example (2)", "options example (3)", "options example with nested reducers", "unused reducers must not cause entry", "`mix` leaves functions as-is"];
    this._prune();
    this._main();
  }
