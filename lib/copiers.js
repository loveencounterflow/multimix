...
(function() {
  ...
  this.object = function(x, seen, seed) {
  ...
  this.list = function(x, seen) {
    return this.object(x, seen, new Array(x.length));
  };

  this.set = function(x, seen) {
    return this.object(x, seen, new Set(x));
  };

  this.map = function(x, seen) {
    return this.object(x, seen, new Map(x));
  };
